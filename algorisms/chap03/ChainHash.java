public class ChainHash<K, V> {
    ...
    class Node<K, V>{
        private K key; // キー値
        private V data; // データ
        private Node<K, V> next; // 接続ポインタ(後続ノードへの参照)
    }
    ...
    // --- キーのハッシュ値を返す --- //
    public int hashCode(){
        return key.hashCode(); // hashCode()メソッドというものが元から存在しているから自分で定義せずに利用可能。
    }
